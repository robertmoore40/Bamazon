...
("The Winds of Winter", "Books", 23.99, 1000),
("The Art of the Deal", "Books", 13.99, 500),
("Instant Pot", "Appliances", 49.99, 60),
("Proton Bars", "Grocery", 1.99, 20000),
("Proton Powder", "Grocery", 43.99, 10),
("10 Dozen Egg Pack", "Grocery", 8.99, 24),
("Banjo-Threeie", "Video Games", 31.99, 250),
